...
public class RuleFactory {
     ...
     *            The generation config options for type generation. These config
     *            options will influence the java code generated by rules created by
     *            this factory.
     * @param annotator
     *            the annotator used to mark up Java types with any annotations that
     *            are required to build JSON compatible types
     * @param schemaStore
    ...
    /**
     * Provides a rule instance that should be applied when an "array" declaration
    ...
    /**
     * Provides a rule instance that should be applied when a "$comment" declaration
     * is found in the schema.
     *
    ...
    /**
     * Provides a rule instance that should be applied when an "enum" declaration is
     * found in the schema.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a "format" declaration
     * is found in the schema.
     *
    ...
    /**
     * Provides a rule instance that should be applied when an "object" declaration
     * is found in the schema.
     *
    ...
    /**
     * Provides a rule instance that should be applied to add constructors to a
     * generated type
     *
     * @return a schema rule that can handle the "object" declaration.
     */
    ...
    /**
     * Provides a rule instance that should be applied when a "required" declaration
     * is found in the schema.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration
     * (child of the "properties" declaration) is found in the schema.
     *
     ...
     * equivalent Java type. Typically invoked for properties, arrays, etc for which
     * a Java type must be found/generated.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a "title" declaration is
     * found in the schema.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a schema declaration is
     * found in the schema.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration
     * is found in the schema to assign any appropriate default value to that
     * property.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration
     * is found in the schema, to assign any minimum/maximum validation on that
     * property
     *
     * @return a schema rule that can handle the "default" declaration.
     */
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration
     * is found in the schema, to assign any size validation (minItems/maxItems) on
     * that property
     *
     * @return a schema rule that can handle the "default" declaration.
     */
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration
     * is found in the schema, to assign any size validation (minLength/maxLength)
     * on that property
     *
     * @return a schema rule that can handle the "default" declaration.
     */
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration
     * is found in the schema, to assign he digits validation on that property.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a "pattern" declaration
     * is found in the schema for a property.
     *
    ...
    /**
     * Provides a rule instance that should be applied when a property declaration
     * is found in the schema which itself contains properties, to assign validation
     * of the properties within that property
     *
     * @return a schema rule that can handle the "default" declaration.
     */
    ...
    /**
     * Gets the configuration options that will influence the java code generated by
    ...
    /**
     * The generation config options for type generation. These config options will
     * influence the java code generated by rules created by this factory.
     *
     * @param generationConfig
     *            Generation config
     */
    ...
    /**
     * Gets the annotator that will in apply annotations to the generated code to
     * allow correct serialization and deserialization, according to the chosen
     * annotation style.
     *
    ...
    /**
     * Provides a rule logger that abstracts the logging method of invoking
     * frameworks
     *
     ...
     * names.
     *
     * @return a name helper instance that can be used to normalize Class and field
     *         names.
     */
    ...
    /**
     * Provides a rule instance that should be applied when a "media" declaration is
     * found in the schema.
     *
    ...
    /**
     * Provides a rule instance that adds methods for dynamically getting, setting,
     * and building properties.
     *
     * @return a schema rule that adds 'dynamic' get and set methods to classes, to
     *         get and set by string property names.
     */
