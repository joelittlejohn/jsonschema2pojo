...
public interface GenerationConfig {
     ...
     *
     * @return whether to include json type information. Commonly used to support
     *         polymorphic type deserialization.
     *
     * @see <a href=
     ...
     *
     * @return whether to include JDK Constructor Properties. Used by serialization
     *         libraries to get parameter names of constructors at runtime. (Not
     *         Available on Android)
     *
     * @see <a href=
     *      "https://docs.oracle.com/javase/7/docs/api/java/beans/ConstructorProperties.html">ConstructorProperties</a>
     */
     ...
     *
     * @return The source file(s) or directory(ies) from which JSON Schema will be
     *         read.
     */
     ...
     *
     * @return The target directory into which generated types will be written (may
     *         or may not exist before types are written)
     */
     ...
     *
     * @return Whether to use the java type {@link java.math.BigInteger} instead of
     ...
     *
     * @return Whether to use the java type {@link java.math.BigDecimal} instead of
     ...
     *
     * @return Whether to use include <code>hashCode</code> and <code>equals</code>
     ...
     *
     * @return Whether to use include a <code>toString</code> method in generated
     *         Java types.
     */
     ...
     *
     * @return An array of strings representing fields that should be excluded from
     *         toString methods
     */
     ...
     *
     * @return Whether to use the 'title' property value as the class name for
     *         object schemas.
     */
     ...
     *         <a href="http://jcp.org/en/jsr/detail?id=303">JSR-303</a> annotations
     ...
     *         (for schema rules like Nullable, NonNull, etc) in generated Java
     *         types.
     */
     ...
     *
     * @return Whether to use {@link java.util.Optional} as return type for getters
     ...
     *
     * @return Whether to empty the target directory before generation occurs, to
     ...
     *
     * @return The character encoding that should be used when writing the generated
     *         Java source files.
     */
     ...
     *
     * @return Whether to use {@link org.joda.time.LocalDate} instead of string when
     *         adding string type fields with a format of date (not date-time) to
     ...
     *
     * @return Whether to use {@link org.joda.time.LocalTime} instead of string when
     *         adding string type fields with a format of time (not date-time) to
     *         generated Java types.
     */
    ...
    /**
     * Gets the file filter used to isolate the schema mapping files in the source
     * directories.
     *
     ...
     *
     * @return An array of strings that should be considered as file extensions and
     *         therefore not included in class names.
     */
    ...
    /**
     * Gets the 'constructorsRequiredPropertiesOnly' configuration option. This is a
     * legacy configuration option used to turn on the
     ...
     *
     * @return whether the resulting object should have a constructor with only the
     *         required properties as parameters or all properties.
     */
    boolean isConstructorsRequiredPropertiesOnly();

    /**
     * Gets the 'includeRequiredPropertiesConstructor' configuration option. This
     ...
     * {@link #isIncludeConstructors()} is not set to true. .
     *
     * @return whether the resulting object should include a constructor with only
     *         the required properties as parameters.
     */
    boolean isIncludeRequiredPropertiesConstructor();

    /**
     * Gets the 'includeAllPropertiesConstructor' configuration option. This
     * property works in collaboration with the {@link #isIncludeConstructors()}
     * configuration option and is incompatible with
     * {@link #isConstructorsRequiredPropertiesOnly()}, and will have no effect if
     * {@link #isIncludeConstructors()} is not set to true.
     *
     * @return whether the resulting object should include a constructor with all
     *         listed properties as parameters.
     */
    boolean isIncludeAllPropertiesConstructor();

    /**
     * Gets the 'includeCopyConstructor' configuration option. This property works
     * in collaboration with the {@link #isIncludeConstructors()} configuration
     * option and is incompatible with
     * {@link #isConstructorsRequiredPropertiesOnly()}, and will have no effect if
     * {@link #isIncludeConstructors()} is not set to true.
     *
     * @return whether the resulting object should include a constructor the class
     *         itself as a parameter, with the expectation that all properties from
     ...
     *
     * @return Whether to allow 'additional properties' support in objects. Setting
     *         this to false will disable additional properties support, regardless
     *         of the input schema(s).
     */
     ...
     *
     * @return Whether to include getters or to omit these accessor methods and
     ...
     *
     * @return Whether to include setters or to omit these accessor methods and
     *         create public fields instead.
     */
     ...
     *
     * @return Whether to include dynamic getters, setters, and builders or to omit
     *         these methods.
     */
     ...
     * </ul>
     *
     * @return The java type to use instead of {@link java.util.Date} when adding
     *         date type fields to generate Java types.
     */
     ...
     * </ul>
     *
     * @return The java type to use instead of string when adding string type fields
     *         with a format of date (not date-time) to generated Java types.
     */
    String getDateType();
     ...
     *
     * @return The java type to use instead of string when adding string type fields
     *         with a format of time (not date-time) to generated Java types.
     */
    String getTimeType();
     ...
     *         <code>@JsonFormat</code> annotation with pattern set to the default
     *         value of <code>yyyy-MM-dd</code>
     */
     ...
     *         <code>@JsonFormat</code> annotation with pattern set to the default
     *         value of <code>HH:mm:ss.SSS</code>
     */
     ...
     *         <code>@JsonFormat</code> annotation with pattern set to the default
     *         value of <code>yyyy-MM-dd'T'HH:mm:ss.SSSZ</code>
     */
     ...
     *
     * @return A string containing any characters that should act as path delimiters
     *         when resolving $ref fragments. By default, #, / and . are used in an
     *         attempt to support JSON Pointer and JSON Path.
     */
     ...
     *         Supported values:
     *         <ul>
     *         <li><code>OS</code> (Let the OS influence the order the source files
     *         are processed.)</li>
     *         <li><code>FILES_FIRST</code> (Case sensitive sort, visit the files
     *         first. The source files are processed in a breadth first sort
     *         order.)</li>
     *         <li><code>SUBDIRS_FIRST</code> (Case sensitive sort, visit the
     *         sub-directories before the files. The source files are processed in a
     *         depth first sort order.)</li>
     *         </ul>
     */
     ...
     *
     * @return An optional mapping from format identifier (e.g. 'uri') to fully
     *         qualified type name (e.g. 'java.net.URI').
     */
     ...
     * anything.
     *
     * @return whether to include the gang of four builder patter on the generated
     *         classes. The default value for this is false.
     */
     ...
     *
     * @return Whether to mark generated classes with the annotation
     *         <code>javax.annotation.@Generated</code>
     *         (<code>javax.annotation.processing.Generated</code> for Java 9 and
     *         later).
     */
    boolean isIncludeGeneratedAnnotation();

    /**
     * Gets the 'useJakartaValidation' configuration option. This property works in
     * collaboration with the {@link #isIncludeJsr303Annotations()} configuration
     * option. If the {@link #isIncludeJsr303Annotations()} returns {@code false},
     * then this configuration option will not affect anything.
     *
     * @return Whether to use
     *         <a href="http://jcp.org/en/jsr/detail?id=303">JSR-303</a> annotations
     *         from {@code jakarta.validation} package instead of
     *         {@code javax.validation} package when adding JSR-303 annotations to
     *         generated Java types
     */
