...
public abstract class JacksonAnnotator extends AbstractTypeInfoAwareAnnotator {
    ...
    protected final JsonInclude.Include inclusionLevel;
    ...
    public void propertyField(JFieldVar field, JDefinedClass clazz, String propertyName, JsonNode propertyNode) {
        ...
        if (field.type().erasure().equals(field.type().owner().ref(Set.class))) {
             addJsonDeserializeAnnotation(field);
        }
    ...
    protected abstract void addJsonDeserializeAnnotation(JFieldVar field);
