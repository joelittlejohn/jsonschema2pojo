...
public class Arguments implements GenerationConfig {
    ...
    @Parameter(names = { "-Rtp", "--remove-target-package" }, description = "Whether to empty the target package before generation occurs, to clear out all source files that have been generated previously (indiscriminately deletes all files and folders under that target package. Non-empty parent packages will NOT be removed). ")
