...
public class ProjectClasspath {
    ...
    /**
     * Provides a class loader that can be used to load classes from this project
     * classpath.
     *
     * @param project
     ...
     *            created classloader.
     * @param log
     *            object to which details of the found/loaded classpath elements can
     *            be logged.
     *
     * @return a classloader that can be used to load any class that is contained in
     *         the set of artifacts that this project classpath is based on.
