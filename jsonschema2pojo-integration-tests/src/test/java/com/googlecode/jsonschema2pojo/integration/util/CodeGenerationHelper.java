...
public class CodeGenerationHelper {
     ...
     */
    public static File generate(String schema, String targetPackage, boolean generateBuilders, boolean usePrimitives, char... wordDelimiters) {
        ...
        return generate(schemaResource, targetPackage, generateBuilders, usePrimitives, wordDelimiters);
    }
     ...
     * @return the directory containing the generated source code
     */
    public static File generate(URL schema, String targetPackage, boolean generateBuilders, boolean usePrimitives, char... wordDelimiters) {
        ...
        try {
            ...
            Jsonschema2PojoMojo pluginMojo = new TestableJsonschema2PojoMojo().configure(
                    sourceDirectory, outputDirectory, targetPackage, generateBuilders, usePrimitives, wordDelimiters, getMockProject());
     ...
     *         generated by the plugin.
     */
    public static ClassLoader generateAndCompile(String schema, String targetPackage, boolean generateBuilders, boolean usePrimitives, char...wordDelimiters) {

        File outputDirectory = generate(schema, targetPackage, generateBuilders, usePrimitives, wordDelimiters);
