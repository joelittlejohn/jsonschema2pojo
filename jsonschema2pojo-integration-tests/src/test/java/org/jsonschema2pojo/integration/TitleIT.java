...
public class TitleIT extends Jsonschema2PojoTestBase {
    private static JavaClass classWithTitle;

    @BeforeEach
    public void generateClasses() throws IOException {

        generateAndCompile("/schema/title/title.json", "com.example");
        File generatedJavaFile = generated("com/example/Title.java");
