...
public class ConstructorsIT {
    ...
    public static void assertHasModifier(int modifier, int modifiers, String modifierName) {
        assertThat("Expected the bit " + modifierName + " (" + modifier + ")" + " to be set but got: " + modifiers, modifier & modifiers, is(equalTo(modifier)));
    }
    ...
    public static void assertHasOnlyDefaultConstructor(Class<?> cls) {
        ...
        assertThat("Expected " + cls + " to only have the default, no-args constructor", constructors[0].getParameterTypes().length, is(equalTo(0)));
    }
    ...
    public static Object getInstance(Class<?> clazz, Object... args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    class DefaultIncludeConstructorsIT {
        ...
        public void generateAndCompileConstructorClasses() throws ClassNotFoundException {
            // @formatter:off
            testClasses = new ConstructorTestClasses(classSchemaRule, config("propertyWordDelimiters", "_", "includeConstructors", true));
            // @formatter:on
        }
    ...
    class RequiredOnlyIT {
        ...
        public void generateAndCompileConstructorClasses() throws ClassNotFoundException {
            // @formatter:off
            testClasses = new ConstructorTestClasses(classSchemaRule, config("propertyWordDelimiters", "_", "includeConstructors", true, "constructorsRequiredPropertiesOnly", true));
            // @formatter:on
        }
    ...
    class IncludeRequiredConstructorsIT {
        ...
        public void generateAndCompileConstructorClasses() throws ClassNotFoundException {
            // @formatter:off
            testClasses = new ConstructorTestClasses(classSchemaRule, config("propertyWordDelimiters", "_", "includeConstructors", true, "includeRequiredPropertiesConstructor", true));
            // @formatter:on
        }
        ...
        /**
         * Test that duplicate constructors are not generated (compile time error is not
         * thrown) when:
         * <ul>
        ...
        public void testGeneratesConstructorWithAllPropertiesRequired() throws Exception {
            classSchemaRule.generate("/schema/constructors/allPropertiesRequiredConstructor.json", "com.example", config("includeConstructors", true, "includeAllPropertiesConstructor", true, "includeRequiredPropertiesConstructor", true));
    ...
    class IncludeCopyConstructorsIT {
        ...
        public void generateAndCompileConstructorClasses() throws ClassNotFoundException {
            // @formatter:off
            testClasses = new ConstructorTestClasses(classSchemaRule, config("propertyWordDelimiters", "_", "includeConstructors", true, "includeCopyConstructor", true));
            // @formatter:on
        }
