...
public class PrefixSuffixIT extends Jsonschema2PojoTestBase {
    ...
    public void customClassPrefixExistingClass() {
        ...
        ClassLoader resultsClassLoader = generateAndCompile("/schema/properties/objectPropertiesJavaType.json",
