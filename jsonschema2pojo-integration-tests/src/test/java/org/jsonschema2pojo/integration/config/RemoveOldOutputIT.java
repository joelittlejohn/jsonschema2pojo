...
public class RemoveOldOutputIT extends Jsonschema2PojoTestBase {
    ...
    public void removeOldOutputCausesOldTypesToBeDeleted(){
        ...
        generate(schema1, "com.example", config("removeOldOutput", true));
        generate(schema2, "com.example", config("removeOldOutput", true));

        assertThrows(ClassNotFoundException.class, () -> compile().loadClass("com.example.PrimitiveProperties"));
    ...
    public void byDefaultPluginDoesNotRemoveOldOutput() throws ClassNotFoundException {
        ...
        compile().loadClass("com.example.PrimitiveProperties");
