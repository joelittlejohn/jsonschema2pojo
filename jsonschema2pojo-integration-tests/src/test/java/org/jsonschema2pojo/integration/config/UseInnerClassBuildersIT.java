...
public class UseInnerClassBuildersIT extends Jsonschema2PojoTestBase {
    ...
    public void noBuilderMethodsByDefault() {
        File outputDirectory = generate("/schema.useInnerClassBuilders/child.json", "com.example", config());
    ...
    public void defaultBuilderIsChainedSetters() throws ClassNotFoundException {
        ClassLoader resultsClassLoader = generateAndCompile("/schema.useInnerClassBuilders/child.json", "com.example",
