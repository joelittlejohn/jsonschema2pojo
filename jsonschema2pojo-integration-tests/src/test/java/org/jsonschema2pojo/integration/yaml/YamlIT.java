...
public class YamlIT {
    ...
    @Test
    public void multipleYamlFilesHavingPropertyWithSameNameAreMappedToCorrectJavaTypes() throws ReflectiveOperationException, IOException {
        ClassLoader resultsClassLoader = schemaRule.generateAndCompile(
                "/yaml/examplesWithSameName",
                "com.example",
                config("sourceType", "YAML"));

        final Class<?> aResponseType = resultsClassLoader.loadClass("com.example.AResponse");
        final Object aResponseValue = objectMapper.readValue(this.getClass().getResourceAsStream("/yaml/examplesWithSameName/AResponse.yaml"), aResponseType);
        ...
        final Object bResponseValue = objectMapper.readValue(this.getClass().getResourceAsStream("/yaml/examplesWithSameName/BResponse.yaml"), bResponseType);
